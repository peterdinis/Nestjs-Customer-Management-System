...
export class AppController {
  ...
  @ApiResponse({ status: 200, description: 'Return all customers.', type: [ViewCustomerDto] })
  @Get("/all")
  ...
  @ApiResponse({ status: 200, description: 'Return a customer.', type: ViewCustomerDto })
  ...
  @ApiBody({ description: 'Customer data', type: CreateCustomerDto, examples: {
    example1: {
  ...
  @ApiParam({ name: 'id', description: 'Customer ID', type: 'number' })
  @ApiBody({ description: 'Customer data', type: UpdateCustomerDto, examples: {
    example1: {
      summary: 'Update a customer',
      value: { name: 'Jane Doe', email: 'jane.doe@example.com' }
    }
  }})
  @ApiResponse({ status: 200, description: 'Customer updated.', type: UpdateCustomerDto })
  @ApiResponse({ status: 404, description: 'Customer not found.' })
  @Put('/update/:id')
  update(@Param('id') id: number, @Body() customerData: UpdateCustomerDto): UpdateCustomerDto {
