...
export class CustomersController {
  ...
  @ApiResponse({ status: 200, description: 'List of customers', type: [ViewCustomerDto] })
  @Get("/all")
  ...
  @ApiResponse({ status: 200, description: 'Customer found', type: ViewCustomerDto })
  ...
  @ApiResponse({ status: 200, description: 'Customer updated successfully', type: UpdateCustomerDto })
  @ApiResponse({ status: 404, description: 'Customer not found' })
  @Put('/update/:id')
  ...
  @ApiResponse({ status: 200, description: 'Customer deleted successfully', type: ViewCustomerDto })
  @ApiResponse({ status: 404, description: 'Customer not found' })
  @Delete('/remove/:id')
